    ...
    const fetchScoreChart = async () => {
      try {
        ...
        if (sessions && sessions.length > 0) {
          ...
          setScoreChartData(chartData.reverse()); // 최신순 → 과거순
        } else {
          setScoreChartData([]);
        }
      } catch (e) {
